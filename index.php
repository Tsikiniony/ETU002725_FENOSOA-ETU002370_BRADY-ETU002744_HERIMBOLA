    ...
    <nav class="navbar navbar-expand-md bg-body py-3" style="box-shadow: 1PX 1PX 4px;">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-2">
                ...
                </ul><a class="btn btn-primary ms-md-2" role="button" href="login-admin.php" style="background: rgb(7,157,4);">ADMIN</a>
            </div>
        </div>
    </nav>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center" style="box-shadow: 0px 0px 1px;">
                            ...
                            <form class="text-center" action="trait-login.php?user" method="post">
                                <div class="mb-3"><input class="form-control" type="text" name="login" value="<?php echo $user["nomUser"] ?>" style="width: 300px;"></div>
                                <div class="mb-3"><input class="form-control" type="password" name="mdp" value="<?php echo $user["mdpUser"] ?>" ></div>
                                <input class="form-control" type="hidden" name="idUser" value="<?php echo $user["idUser"] ?>" >
                                <?php
