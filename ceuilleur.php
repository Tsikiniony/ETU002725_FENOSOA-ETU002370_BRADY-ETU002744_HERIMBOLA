    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: rgb(7,157,4);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Ceuilleur</span></div>
                </a>
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="ceuilleur.php"><i class="far fa-user-circle"></i><span>Ceuilleurs</span></a>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                            for($i = 0; $i < count($ceuilleur); $i++){
                                ?>
                                <form action="trait-admin.php?ceuilleur" method="post">
                                    <tr>
                                        <td><?php echo $ceuilleur[$i]['idCeuilleur'] ?></td>
                                        <input type="hidden" name="id" value="<?php echo $ceuilleur[$i]['idCeuilleur'] ?>">
                                        <td><input type="text" name="nom" value="<?php echo $ceuilleur[$i]['nomCeuilleur'] ?>"></td>
                                        <td><input type="text" name="genre" value="<?php echo $ceuilleur[$i]['genre'] ?>"></td>
                                        <td><input type="date" name="dtn" value="<?php echo $ceuilleur[$i]['dateNaissance'] ?>"></td>
                                        <td><input type="number" step="0.01" name="salaire" value="<?php echo $ceuilleur[$i]['salaire'] ?>"></td>
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                                <div class="card mb-5">
                                    <div class="card-body p-sm-5">
                                        ...
                                        <form action="trait-admin.php?ceuilleur" method="post">
                                            <div class="mb-3"><input class="form-control" type="text" id="name-2" name="nom" placeholder="Nom"></div>
                                            <div class="mb-3"><select class="form-control" type="text" id="email-2" name="genre" placeholder="Genre">
                                                <option value="f">Feminin</option>
                                                <option value="m">Masculin</option>
                                            </select>
                                            <input class="form-control" type="date" id="email-1" name="dtn" placeholder="Date de naissance" style="margin-top: 18px;"></div>
                                            <div class="mb-3"></div>
                                            <div class="mb-3"><input class="form-control" type="number" step="0.01" id="name-2" name="salaire" placeholder="Salaire"></div>
