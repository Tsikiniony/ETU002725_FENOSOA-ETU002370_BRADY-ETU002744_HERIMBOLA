    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: rgb(7,157,4);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Variete thé</span></div>
                </a>
                <hr class="sidebar-divider my-0">
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="variete.php"><i class="fas fa-seedling"></i><span>Variete de The</span></a></li>
                    ...
                    <div class="scrollable-table">
                        ...
                        <?php
                            for($i = 0; $i < count($variete); $i++){
                                ?>
                                <form action="trait-admin.php?the" method="post">
                                    <tr>
                                        <td><?php echo $variete[$i]['idThe'] ?></td>
                                        <input type="hidden" name="id" value="<?php echo $variete[$i]['idThe'] ?>">
                                        <td><input type="text" name="nom" value="<?php echo $variete[$i]['nomThe'] ?>"></td>
                                        <td><input type="number" step="0.01" name="occupation" value="<?php echo $variete[$i]['occupation'] ?>"></td>
                                        <td><input type="number" step="0.01" name="rendement" value="<?php echo $variete[$i]['rendement'] ?>"></td>
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                                <div class="card mb-5">
                                    <div class="card-body p-sm-5">
                                        <h2 class="text-center mb-4">Ajouter thé</h2>
                                        <form action="trait-admin.php?the" method="post">
                                            <div class="mb-3"><input class="form-control" type="text" id="name-2" name="nom" placeholder="Nom the"></div>
                                            <div class="mb-3"><input class="form-control" type="number" step="0.01" id="email-2" name="occupation" placeholder="Occupation">
                                            <input class="form-control" type="number" step="0.01" id="email-1" name="rendement" placeholder="Rendement" style="margin-top: 18px;"></div>
                                            <div class="mb-3"></div>
