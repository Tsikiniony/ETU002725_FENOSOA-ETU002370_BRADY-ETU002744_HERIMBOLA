    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: rgb(7,157,4);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Depense</span></div>
                </a>
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <a class="nav-link active" href="depense.php"><i class="far fa-money-bill-alt"></i><span>Depenses</span></a>
                    ...
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <table class="table table-bordered">
                            ...
                            for($i = 0; $i < count($depense); $i++){
                                ?>
                                <form action="trait-admin.php?depense" method="post">
                                    <tr>
                                        <td><?php echo $depense[$i]['idDepense'] ?></td>
                                        <input type="hidden" name="id" value="<?php echo $depense[$i]['idDepense'] ?>">
                                        <td><input type="text" name="nom" value="<?php echo $depense[$i]['nomDepense'] ?>"></td>
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                                <div class="card mb-5">
                                    <div class="card-body p-sm-5">
                                        <h2 class="text-center mb-4">Ajouter Depense</h2>
                                        <form action="trait-admin.php?depense" method="post">
                                            <div class="mb-3"><input class="form-control" type="text" id="email-2" name="nom" placeholder="Nom Depense"></div>
                                            <div class="mb-3"></div>
